 ...
 *   nabuur_blog_regions()
 * where nabuur_blog is the name of your sub-theme. For example, the zen_classic
 ...
 * use these functions:
 *   nabuur_blog_preprocess_page(&$vars)     to add variables to the page.tpl.php
 *   nabuur_blog_preprocess_node(&$vars)     to add variables to the node.tpl.php
 *   nabuur_blog_preprocess_comment(&$vars)  to add variables to the comment.tpl.php
 *   nabuur_blog_preprocess_block(&$vars)    to add variables to the block.tpl.php
 */
 ...
 */
/* -- Delete this line if you want to use this function
function nabuur_blog_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function nabuur_blog_preprocess_page(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function nabuur_blog_preprocess_node(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function nabuur_blog_preprocess_comment(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function nabuur_blog_preprocess_block(&$vars) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
